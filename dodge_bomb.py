...
def main():
    ...
    kurohaikei_img = pg.Surface((1100, 650))
    pg.draw.rect(kurohaikei_img, (0, 0, 0), (0, 0, 1100, 650))
    kurohaikei_rct = kurohaikei_img.get_rect()
    kurohaikei_rct.center = 550, 325
    kurohaikei_img.set_alpha(200)
    ...
    def gameover(screan: pg.Surface) -> None:
        ...
        screan.blit(cry_img, [730, 300])
        screan.blit(cry_img, [330, 300])
        pg.display.update()
        time.sleep(5)
